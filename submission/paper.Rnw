...
% \usepackage{thumbpdf,lmodern} # thumbpdf give me installation problems
\usepackage{lmodern}
...
opts_chunk$set(prompt = TRUE, fig.path = "Figures/")
...
\begin{figure}[t!]
\centering
<<visualization, echo=FALSE, fig.height=5.2, fig.width=7>>=
par(mar = c(4, 4, 1, 1))
